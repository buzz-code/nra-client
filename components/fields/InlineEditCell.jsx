...
/**
 * A true inline-editable cell for React-Admin Datagrids: click a field to
 * edit it in place, no dialog and no custom key handling. A lone text field
 * inside a <form> submits on Enter natively, so <Form> + <TextInput> is all
 * that's needed for that; blur commits the change if it's dirty.
 *
...
export const InlineEditCell = ({
    ...
    // formData is null to just close without saving (unchanged blur); the
    // submitted values otherwise.
