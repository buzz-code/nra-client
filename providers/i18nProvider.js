...
const extendedTranslation = {
    ra: {
        action: {
            ...
            import_fields_info: 'עמודות לייבוא',
            download_template: 'הורדת קובץ לדוגמה',
            export_excel: 'אקסל',
            export_pdf: 'pdf',
            export_json: 'json',
            hangup: 'נתק שיחה',
        ...
        message: {
            ...
            import_fields_description: 'יש להקפיד על סדר העמודות הבא בקובץ המיובא. ניתן להוריד קובץ לדוגמה עם הכותרות המתאימות.',
